...
### 👉 [**CLICK HERE TO INSTALL USERSCRIPT (v1.7.7)**](https://raw.githubusercontent.com/tazztone/scripts/main/userscripts/huggingface/huggingface-heart.user.js?v=1.7.7)
