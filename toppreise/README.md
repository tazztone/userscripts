...
### 👉 [**CLICK HERE TO INSTALL USERSCRIPT**](https://github.com/tazztone/scripts/raw/refs/heads/main/userscripts/toppreise/toppreise.user.js?v=0.8.0)
...
3. **Kategorien-Filter (Neue Toppreise & Suche)**: Scans active product cards on the current page to provide interactive, high-contrast dark pills for permanently hiding unwanted categories.
